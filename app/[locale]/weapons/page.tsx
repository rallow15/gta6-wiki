...
const weapons: OfficialWeapon[] = [
  // Pistols
  { id: "girardi-klose-pistols", name: "Girardi ES9 & Klose K17", category: "Pistolet", categoryEn: "Pistol", description: "Les deux pistolets officiels vus côte à côte : le Girardi ES9 (inspiré du Beretta 92FS), arme de préférence de Jason, et le Klose K17 (inspiré du Glock 17), arme principale de Lucia capable de tirer en mode automatique complet. Variantes personnalisées pour chacun dans l'Édition Ultime.", descriptionEn: "The two official pistols seen side by side: the Girardi ES9 (inspired by the Beretta 92FS), Jason's preferred weapon, and the Klose K17 (inspired by the Glock 17), Lucia's primary weapon capable of full automatic fire. Custom variants for each in the Ultimate Edition.", source: "Trailer 2 + Screenshots officiels", accent: "cyan", image: `${imgBase}/girardi-klose-pistols.webp` },
