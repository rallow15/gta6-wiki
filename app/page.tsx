          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="glass-card p-6 text-center">
                <div className="h-12 w-12 mx-auto mb-4 rounded-lg bg-neon-pink/10 flex items-center justify-center">
              ...
              <div className="glass-card p-6 text-center">
                <div className="h-12 w-12 mx-auto mb-4 rounded-lg bg-sunset-orange/10 flex items-center justify-center">
              ...
              <div className="glass-card p-6 text-center">
                <div className="h-12 w-12 mx-auto mb-4 rounded-lg bg-lagoon-cyan/10 flex items-center justify-center">
