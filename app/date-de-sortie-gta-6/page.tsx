...
export const metadata: Metadata = {
  title: "Date de sortie GTA 6 : le 19 novembre 2026",
  description:
    "Date de sortie de GTA 6 (Grand Theft Auto VI) : 19 novembre 2026 sur PS5, Xbox Series X|S et PC. Historique des reports, éditions, prix et plateformes.",
  alternates: { canonical: "/date-de-sortie-gta-6" },
  keywords: [
  ...
  openGraph: {
    title: "Date de sortie GTA 6 : le 19 novembre 2026 | CodeTricheGTA6",
    description:
      "GTA 6 sort le 19 novembre 2026 sur PS5, Xbox Series X|S et PC. Historique des reports, éditions et prix.",
    url: "/date-de-sortie-gta-6",
    type: "article",
  },
};
...
export default function DateSortiePage() {
  return (
    <>
      <JsonLd
        data={[
