...
export const metadata: Metadata = {
  title: "Astuces GTA 6 — Tips, guides et conseils pour GTA VI",
  description:
    "Toutes les astuces GTA 6 (tips) : conseils de démarrage, meilleures stratégies, farming, secrets et astuces de gameplay pour maîtriser GTA VI dès le premier jour.",
  alternates: { canonical: "/astuces-gta-6" },
  keywords: [
    "astuces GTA 6",
    "tips GTA 6",
    "conseils GTA 6",
  ...
  openGraph: {
    title: "Astuces GTA 6 — Tips et conseils | CodeTricheGTA6",
    description: "Toutes les astuces et conseils pour GTA 6 : démarrage, stratégies, farming et secrets.",
    url: "/astuces-gta-6",
    type: "article",
  },
};
...
export default function AstucesGTA6Page() {
  return (
    <>
      <JsonLd
        data={[
