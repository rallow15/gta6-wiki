...
export const metadata: Metadata = {
  title: "Meilleures voitures GTA 6 — Classement des véhicules GTA VI",
  description:
    "Classement des meilleures voitures de GTA 6 (GTA VI) : sportives, supercars, muscle cars et SUV confirmés. Fiches détaillées, inspiration réelle et source officielle.",
  alternates: { canonical: "/meilleures-voitures-gta-6" },
  keywords: [
  ...
  openGraph: {
    title: "Meilleures voitures GTA 6 | CodeTricheGTA6",
    description: "Classement des meilleures voitures de GTA 6 (sportives, supercars, muscle cars).",
    url: "/meilleures-voitures-gta-6",
    type: "website",
  },
};
...
export default function MeilleuresVoituresPage() {
  return (
    <>
      <JsonLd
        data={[
