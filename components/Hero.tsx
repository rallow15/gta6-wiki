    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 text-center pt-20 sm:pt-24">
        ...
        >
          ...
          <MagneticButton
            strength={20}
            className="inline-flex items-center gap-2 rounded-lg border border-lagoon-cyan/30 px-6 py-3 text-sm font-semibold text-lagoon-cyan transition-all hover:border-lagoon-cyan/60 hover:bg-lagoon-cyan/5"
            onClick={() => window.open("https://discord.gg/PXDdQF4TPr", "_blank")}
          >
